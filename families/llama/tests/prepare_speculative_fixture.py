...
"""Create one reproducible raw-text/ID fixture for independent runtimes."""
...
def main():
    ...
    (args.output_dir / "edge-input.json").write_text(json.dumps({
        "batch_size": 1, "temperature": 0.0, "top_k": 1, "top_p": 1.0,
        "max_generate_length": 100, "apply_chat_template": False,
